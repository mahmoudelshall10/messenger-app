            ...
            <div class="py-6 py-lg-12" id="chat-body">
                ...
                <div v-for="message in $root.messages" v-bind:key="message.id" class="message" :class="{'message-out': message.user_id == $root.userID}">
                    <a href="#" data-bs-toggle="modal" data-bs-target="#modal-profile"  class="avatar avatar-responsive">
                        <img class="avatar-img" v-bind:src="message.user.avatar_url" v-bind:alt="message.user.name">
                    </a>
                        ...
                        <div class="message-body">
                            <div class="message-content">
                                ...
                                <div class="message-gallery" v-if="message.type=='attachment' && message.body.mimetype.match(/image\/.+/)">
                                    <div class="row gx-3">
                                        <div class="col">
                                            <img class="img-fluid rounded" v-bind:src="'/storage/'+message.body.file_path" data-action="zoom" v-bind:alt="message.body.file_name" >
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="message-text" v-if="message.type=='attachment' && !message.body.mimetype.match(/image\/.+/)">
                                    <div class="row align-items-center gx-4">
                                        <div class="col-auto">
                                            <a v-bind:href="'/storage/'+message.body.file_path" class="avatar avatar-sm" download>
