<template>
    <div class="chat-footer pb-3 pb-lg-7 position-absolute bottom-0 start-0">
        ...
        <!-- Chat: Form -->
        <form class="chat-form rounded-pill bg-dark" data-emoji-form="" action="/api/messages" @submit.prevent="sendMessage()" >
            ...
            <div class="row align-items-center gx-0">
                ...
                <div class="col">
                    <div class="input-group">
                        <textarea class="form-control px-0" @keypress="startTyping()" @focus="$root.markAsRead($root.conversation)" placeholder="Type your message..." v-model="message" id="body" rows="1" data-emoji-input="" data-autosize="true"></textarea>
