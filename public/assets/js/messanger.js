...
const addMessage = function(msg,c = ''){
    ...
    <a href="#" data-bs-toggle="modal" data-bs-target="#modal-profile"  class="avatar avatar-responsive">
        <img class="avatar-img" src="${msg.user.avatar_url}" alt="${msg.user.name}">
    </a>
        ...
        <div class="row gx-5">
            <div class="col-auto">
                <div class="avatar avatar-online">
                    <img src="${chat.participants[0].avatar_url}" alt="${chat.participants[0].name}" class="avatar-img">
                </div>
            </div>
...
$("#chat-list").on('click',"[data-messages]",function(e){
    ...
    $.get(`/api/conversations/${id}/messages`,function(response){
        ...
        $("#chat-avatar").attr('alt',response.conversation.participants[0].name);
